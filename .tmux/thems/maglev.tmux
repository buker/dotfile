...
apply_theme() {
    ...
    status_left="#{prefix_highlight}#[fg=$session_fg,bg=$session_bg,bold] ❐ #S #[fg=$session_bg,bg=$status_bg,nobold]$left_separator_black"
    ...
    status_right="︎#[fg=$time_date_fg,nobold]$right_separator %R $right_separator %a %d %b #[fg=$host_bg]$right_separator_black#[fg=$host_fg,bg=$host_bg,bold] #{battery_icon}#{battery_percentage} $right_separator#{cpu_icon}#{cpu_percentage}$right_separator#{online_status}"
